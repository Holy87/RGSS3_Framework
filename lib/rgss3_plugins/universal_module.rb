 ...
 ==============================================================================
  ...
  ▼ Internet e HTTP
    ...
    * Metodi semplificati per operazioni asincrone
    ...
    ● send_post_request(url, parametri)
...
module H87_ModConfig
  HTTPDOMAIN = "http://holyres.altervista.org/demoscript"#"http://miosito.com/"
...
module Win
  ...
  def self.window_frame_width
    return GetSystemMetrics.call(7)
  end
  # --------------------------------------------------------------------------
  ...
  def self.window_title_height
    return GetSystemMetrics.call(4)
  end
  #-----------------------------------------------------------------------------
  ...
  def self.screen_resolution
    x = GetSystemMetrics.call(16)
    y = GetSystemMetrics.call(17)
    return [x,y]
  end
  #-----------------------------------------------------------------------------
...
module Clipboard
  ...
  # TODO: Make methods for other format handling
  #-----------------------------------------------------------------------------
  # Opens the clipboard
  # @return [Integer]
  #-----------------------------------------------------------------------------
...
module HTTP
  ...
  # @return [String]
  #--------------------------------------------------------------------------
  def self.send_post_request(url, params)
...
module Kernel
  ...
  def submit_post_request(url, params)
    HTTP.send_post_request(url, params)
  end
end
