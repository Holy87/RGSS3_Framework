...
class Game_Map
  ...
  # @return [Game_Screen] screen
  attr_reader :screen # map screen state
  # @return [Game_Interpreter] interpreter
  attr_reader :interpreter # map event interpreter
  # @return [Hash<Game_Event>] events
  ...
  # @return [Array<Game_Vehicle>] vehicles
