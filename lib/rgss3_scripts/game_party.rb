...
class Game_Party < Game_Unit
  ...
  # @return [Game_BaseItem] last_item
  ...
  # @return [Array<RPG::Weapon>, Array<RPG::Armor>, Array<RPG::Item>]
  ...
  # @param [TrueClass, FalseClass] include_equip
