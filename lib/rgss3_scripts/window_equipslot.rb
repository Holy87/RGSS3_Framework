...
class Window_EquipSlot < Window_Selectable
  ...
  # @return [Window_EquipStatus] status_window
  attr_reader :status_window # Status window
  # @return [Window_EquipItem] item_window
  ...
  # Set Status Window
  # @param [Window_EquipStatus] status_window
  ...
  # Set Item Window
  # @param [Window_EquipItem] item_window
